...
| **RASCO Monitoring Tool** · [public case study](https://github.com/PawanYadav007s/rasco-monitoring-tool-showcase) | Built an industrial monitoring solution for equipment visibility, operational data capture, diagnostics, and reliable shop-floor use | C#/.NET agent, FastAPI, PostgreSQL, WebSockets, networking |
| **Seal Press Application** · [public case study](https://github.com/PawanYadav007s/seal-press-showcase) | Developed production software supporting seal-press operations, process control, data recording, and operator workflows | Python, PyQt6, PLC integration, PostgreSQL |
| **Army Rear Axle Assembly** · [public case study](https://github.com/PawanYadav007s/army-rear-axle-assembly-showcase) | Developed a manufacturing application for rear-axle assembly workflows, production traceability, validation, and reporting | Python, PyQt6, Siemens S7, PostgreSQL, reporting |
